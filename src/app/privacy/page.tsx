...
export default function Legal() {
  return (
    <div className="w-[80%]">
      <h3 className="text-2xl text-center">Privacy Policy for 10 tips</h3>

      <div className="translations-content-container mt-10">
        <div className="container ">
          <div
            className="tab-content translations-content-item en visible"
            id="en"
          >
            <h3 className="text-lg my-5 font-bold">Privacy Policy</h3>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  We, Us or Our in this Agreement) refers to 10 tips.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to 10 tips, accessible from{" "}
                  <Link
                    href="www.10tipsonline.com"
                    rel="external nofollow noopener"
                    target="_blank"
                  >
                    www.10tipsonline.com
                  </Link>
                </p>
              </li>
              <li>
            ...
            <h3 className="text-lg my-5 font-bold">Personal Data</h3>
            <p>
            ...
            <h3 className="text-lg my-5 font-bold">Usage Data</h3>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  communication, such as a mobile applications push
            ...
            <h3 className="text-lg my-5 font-bold">Business Transactions</h3>
            <p>
            ...
            <h3 className="text-lg my-5 font-bold">Law enforcement</h3>
            <p>
            ...
            <h3 className="text-lg my-5 font-bold">Other legal requirements</h3>
            <p>
            ...
            <h3 className="text-lg my-5 font-bold">Childrens Privacy</h3>
            <p>
            ...
            <h3 className="text-lg my-5 font-bold">Links to Other Websites</h3>
            <p>
            ...
            <h3 className="text-lg my-5 font-bold">Contact Us</h3>
            <p>
            ...
            <ul>
              <li>
                ...
                <Link
                  href="https://www.10tipsonline.com/legal"
                  rel="external nofollow noopener"
                  target="_blank"
                >
                  https://www.10tipsonline.com/legal
                </Link>
              </li>
            </ul>
          </div>
